...
- Schema checkpoints: the original Yelp release was exact at `48/48`. Production is now exact at `51/51`; the reviewed AI/automation/Mighty release set is `62/62` locally and on the isolated regression target but has not been applied to Production.
