...
const providerGuideEnv = {
  twilio: [
    ...
    twilioEnvVars.weatherTechPhoenixPublicNumber,
    twilioEnvVars.weatherTechPhoenixVoiceForwardTo,
    twilioEnvVars.weatherTechTucsonVoiceForwardTo,
    twilioEnvVars.ihcPublicNumber,
    twilioEnvVars.ihcVoiceForwardTo,
  ],
  googleWorkspace: [
...
export const productionActivationGuides: ProductionActivationGuide[] = [
  {
    ...
    rollbackProcedure: [
      "Remove carrier forwarding first, then clear only the affected Phoenix or IHC Voice webhook in Twilio Console.",
      "Disable the affected route gate and restore only its route capability to SMS if voice rollback is required.",
      "For Tucson rollback, disable its gate before restoring the prior protected terminal; do not alter its existing Twilio webhook or SMS route.",
  ...
  return [
    ...
    },
    {
      ...
      disabledSafetyFlags: [
        ...
        twilioEnvVars.ihcVoiceForwardingEnabled ??
  ...
  return [
    ...
    buildEnvironmentGroup(
      ...
      [
        ...
        {
          name: twilioEnvVars.weatherTechPhoenixVoiceForwardingEnabled,
          classification: "disabled_safety_flag",
        },
        {
        ...
        {
          name: twilioEnvVars.ihcVoiceForwardingEnabled,
          classification: "disabled_safety_flag",
        },
      ],
      env,
